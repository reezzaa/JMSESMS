  ...
  <a href="#" id="to-top"><i class="fa fa-angle-double-up"></i></a>
    ...
    <script src="{{ asset('js/pages/tablesDatatables.js') }}"></script>
        ...
        <script type="text/javascript">
            $('.buttons-copy, .buttons-csv, .buttons-excel, .buttons-pdf, .buttons-print').each(function() {
                $(this).removeClass('btn-default').addClass('btn').addClass('btn-alt').addClass('btn-primary')
            })
        </script>
