        ...
        <div class="modal-content">
          <div class="block">
             <div class="block-title themed-background">
                ...
                <h3 class="themed-background" style="color:white;"><strong>Edit Service </strong></h3>
              </div>
        ...
        <div class="modal-content">
          <div class="block">
            <div class="block-title themed-background">
              ...
              <h3 class="themed-background" style="color:white;"><strong>Delete Service</strong></h3>
            </div>
